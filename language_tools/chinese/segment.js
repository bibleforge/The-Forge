    ...
    return (function ()
    {
        ...
        get_significance = (function ()
        {
            ...
            if (trad) {
                ...
                p = [{"x":0,"y":8105},{"x":66,"y":1084},{"x":140,"y":735},{"x":334,"y":427},{"x":987,"y":193},{"x":2970,"y":73},{"x":8222,"y":23},{"x":51145,"y":1}];
            } else {
                /// Created in the Forge on Sun, 14 Apr 2013 13:49:27 GMT.
                /// Simplified Chinese Plot Data
                p = [{"x":0,"y":8105},{"x":69,"y":1084},{"x":143,"y":735},{"x":337,"y":427},{"x":1011,"y":193},{"x":3058,"y":72},{"x":8360,"y":23},{"x":52237,"y":1}];
            }
